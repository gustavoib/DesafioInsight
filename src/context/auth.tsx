...
// Definição do componente AuthProvider 
// O componente AuthProvider é um provedor de autenticação que permite o login e logout do usuário e o cadastro, listagem, edição e exclusão de fornecedores
